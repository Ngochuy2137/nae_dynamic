...
def main():
    ...
    data_folder = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae_prediction_ws/src/nae/data/new_dataset_no_orientation/frisbee/frisbee-pbl/new_data_format/frisbee-pbl/split'
