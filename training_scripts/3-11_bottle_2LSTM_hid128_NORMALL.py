...
def main():
    ...
    data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae_fix_dismiss_acc/nae_core/data/nae_paper_dataset/data_preprocessed/norm_all_features/Bottle'
    thrown_object = '3-11_bottle_2LSTM_hid128_NORMALL.py'
    
    checkout_path = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae_fix_dismiss_acc/nae_core/models/3-11_bottle_2LSTM_hid128_NORMALL.py_model/ACC-repair-3-11_bottle_2LSTM_hid128_NORMALL.py-model_06-01-2025_02-15-24_hiddensize32/epochs14999_data9206_batchsize512_hiddensize32_timemin554-22_NAE_DYNAMIC/midway_checkpoint/checkpoint.pth'
    wdb_run_id='ad9iekji'   # 't5nlloi0'
