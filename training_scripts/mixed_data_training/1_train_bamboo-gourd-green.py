...
def main():
    ...
    data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/mixed_data/mixed_data-bamboo-gourd-green'
    thrown_object = 'bamboo-gourd-green'
