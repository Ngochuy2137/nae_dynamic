...
def main():
    ...
    # cd to general_data
    data_subfolder = 'nae_paper_dataset/' + thrown_object
    ...
    nae = NAE(**model_params, **training_params, data_dir=data_subfolder, device=DEVICE)
    # load data
    ...
    checkpoint_path = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae/training_scripts/models/mixed_data-input-10pred-15/run_NAE3L_28-10-2024_00-40-14/epochs9900_data2_batchsize1024_seq10_pred15_timemin424-54/midway_checkpoint/checkpoint.pth'
