...
class RoCatDataRawInvestigator:
    ...
    def plot_trajectory_dataset(self, data_raw, thrown_object, rotate_data_whose_y_up=False, num_data_to_plot=None):
        ...
        global_util_plotter.plot_trajectory_dataset_plotly(trajectories, title=thrown_object, rotate_data_whose_y_up=rotate_data_whose_y_up)
...
def main():
    ...
    # data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/new_dataset_no_orientation/frisbee_can_loc_z_be_hon_0p5/backup/frisbee-pbl_merged_275.npz'
    # thrown_object = 'frisbee-pbl-OLD'

    # data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/new_dataset_no_orientation/frisbee_can_loc_z_be_hon_0p5/frisbee-pbl/new_data_format/frisbee-pbl/frisbee-pbl_new_data_format_num_275.npz'
    # thrown_object = 'frisbee-pbl-NEW'


    # data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/nae_paper_dataset/new_data_format/bamboo/bamboo_new_data_format_num_168.npz'
    # thrown_object = 'bamboo-NEW'
    # # investigator.analyze_data(data_dir)
    # data_raw = investigator.load_data(data_dir)


    # data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/nae_paper_dataset/origin/trimmed_Banana_731'
    data_dir = '/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/dynamic_nae/nae_core/data/new_dataset_no_orientation/frisbee_can_loc_z_be_hon_0p5/new_data_format/frisbee-pbl/frisbee-pbl_new_data_format_num_275.npz'
    thrown_object = 'frisbee-pbl'
    
    data_raw = RoCatRLLabDataRawReader(data_dir).read()

    for i in range(len(data_raw)):
        trajectory = data_raw[i]
        global_util_plotter.plot_trajectory_dataset_matplotlib([trajectory], title=f'Trajectory {i}', rotate_data_whose_y_up=True, plot_all=False, shuffle=False)
    ...
    # investigator.plot_trajectory_dataset(data_raw=data_raw, thrown_object=thrown_object, rotate_data_whose_y_up=False)
